...
function registerRelationship(currentSubject, type, subject, usecase) {
    ...
    var subjectObj, id, definition, relationships, names, related;
    ...
    if (related) {
        throw new Error(
            currentSubject + '/' + currentName + " has \u00ab" +
            type + "\u00bb has cyclic redundant relationship with " + id);
    }
