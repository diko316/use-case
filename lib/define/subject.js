...
function registerRelationship(currentSubject, type, subject, usecase) {
    ...
    var subjectObj, id, definition, relationships,
        names, currentId, lastUsecase;
    ...
    // register usecase
    subjectObj = system.subject(subject);
    lastUsecase = subjectObj.lastUsecase;
    subjectObj.usecase(usecase);
    subject = subjectObj.name;
    usecase = subjectObj.lastUsecase;
    // return to last usecase
    subjectObj.lastUsecase = lastUsecase;
